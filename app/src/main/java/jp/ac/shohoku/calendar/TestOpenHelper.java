...
public class TestOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "caldb";
    private static final String _ID = "_id";
    private static final String COLUMN_NAME_TITLE = "date";
    private static final String COLUMN_NAME_SUBTITLE = "item";
    ...
    public void saveData(SQLiteDatabase db, String date, String item ){
        ContentValues values = new ContentValues();
        values.put("date", date);
        values.put("item", item);

        db.insert("caldb", null, values);
    }
}
